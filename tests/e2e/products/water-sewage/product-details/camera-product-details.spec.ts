...
import {navigateToCameraProductsPageOnMobileAndCloseMenu} from "../../../utils/navigation/navigateProductsMenuOnMobile";
...
test.describe("camera product details suite", () => {
    ...
    test.describe("mobile version", () => {
       ...
       test.beforeAll(async ({ browser }) => {
           ...
           await navigateToCameraProductsPageOnMobileAndCloseMenu(mobilePage);
        ...
        test.describe("right column", () => {
            ...
            test.describe("polish version", () => {
                ...
                test.beforeAll(async ({ browser }) => {
                    ...
                    await navigateToCameraProductsPageOnMobileAndCloseMenu(mobilePage, Language.PL);
