...
export const PressureVehiclesTags: Record<string, Tag> = {
    AdditionalEquipmentTag,
    AdditionalTanksTag,
    AddoptionToUrbanInfrastructureTag,
    AdrComplianceTag,
    AdvertisingSpaceTag,
    AirCoolingTag,
    ...
    ChassinTypeTag,
    CleaningSystemTag,
    CompactSuctionBarrelTag,
    ContinuousCleaningTag,
    CleaningHosesTag,
    CustomConfigurationTag,
    CustomOrderTag,
    DualFunctionVehiclesTag,
    EaseOfRepairTag,
    EasyMaintananceTag,
    EnvironmentallyFriendlyOperationTag,
    EquipmentOptionsTag,
    ExtendableArmTag,
    FriendlyConstructionTag,
    FunctionalityTag,
    GalvanizedMaterialsTag,
    HardToReachAreasTag,
    HazardousMaterialsTransportTag,
    HighPressureModulesTag,
    HighPressureCleaningNozzlesTag,
    HighPressurePompsTag,
    HighPressureSystemTag,
    HoseStackingPlatformTag,
    IsolationTag,
    ...
    LargeTankVolumeTag,
    LiquidWasteTag,
    LowInstallationWeightTag,
    LowWidthTag,
    LowUnladenWeightTag,
    PersonalizationTag,
    PneumaticPartitionTag,
    OptimalWeightDistributionTag,
    QuietDriveTag,
