...
import {
    AITag,
    CamerasForSewageInspectionTag, ChassisMountedSystemsTag,
    ContinuousPipeInspectionTag,
    DN100Tag,
    ExplosiveProofInspectionSystemsTag,
    HDSystemsTag,
    MainlineSewerInspectionSystemsTag,
    PanoramoTag,
    RotaxTag, SelfPropelledTrolleysTag,
    SpecializedChassisForVehiclesTag,
    TransmitterForSewageTag,
    TrolleyAssistantTag
} from "../cameras-tags";

export const MainSewerInspectionSystems: ProductItem = {
    name: {
        namePL: "Systemy inspekcyjne w wersji do kanałów głównych",
        nameENG: "Main sewer inspection systems",
    },
    href: "/products/water-sewage/cameras/main-sewer-inspection-systems",
    images: [
        mainSewerInspSys01,
        mainSewerInspSys02,
        mainSewerInspSys03,
