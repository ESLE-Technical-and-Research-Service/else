...
export const Trainings: Service = {
    ...
    title: {
        [Language.PL]: "Szkolenia z obsługi i konserwacji systemów inspekcyjnych",
        [Language.ENG]: "Training in Operation and Maintenance of Inspection Systems"
    },
