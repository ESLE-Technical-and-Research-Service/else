...
export const TechnicalSupport: Service = {
    ...
    title: {
        [Language.PL]: "Eksperckie wsparcie techniczne zapewniające niezawodność",
        [Language.ENG]: "Expert Technical Assistance Ensuring Reliability",
    },
    ...
    description: {
        [Language.PL]: "Nasz zespół Wsparcia Technicznego zapewnia kompleksową pomoc w zakresie obsługi systemów i aplikacji, gwarantując ich niezawodne działanie. Dzięki szybkiej reakcji i skutecznym rozwiązaniom minimalizujemy przestoje oraz zwiększamy efektywność operacyjną.",
        [Language.ENG]: "Our Technical Support team is dedicated to ensuring seamless operation of your systems and applications. We provide prompt assistance to address technical issues, minimizing downtime and enhancing productivity.",
    },
    detailedDescription: {
        [Language.PL]: (
            <>
